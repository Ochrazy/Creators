...
#include "CreatorsCameraComponent.generated.h"

UCLASS(config=Game,BlueprintType, HideCategories=Trigger, meta=(BlueprintSpawnableComponent))
class UCreatorsCameraComponent : public UCameraComponent
{
...
public:
	 ...
	 * @param	DownTime			Time pressed
	 */
	void OnPinchUpdate(class UCreatorsInput* InputHandler, const FVector2D& ScreenPosition1, const FVector2D& ScreenPosition2, float DownTime);
