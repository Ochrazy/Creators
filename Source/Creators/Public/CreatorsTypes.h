...
#include "CreatorsTypes.generated.h"

#pragma once

UENUM(BlueprintType)
namespace ECreatorsTeam
{
	enum Type
	{
		Unknown,
...
{
	TSharedPtr<class SCreatorsButtonWidget> Widget;
...
struct FPlayerData
{
	...
	/** HQ */
	TWeakObjectPtr<class ACreatorsBuilding_Brewery> Brewery;
