...
UCreatorsInput::UCreatorsInput(const FObjectInitializer& ObjectInitializer) 
	: Super(ObjectInitializer)
	, PrevTouchState(0)
{
}

void UCreatorsInput::UpdateDetection(float DeltaTime)
{
	UpdateGameKeys(DeltaTime);
	ProcessKeyStates(DeltaTime);
}

void UCreatorsInput::ProcessKeyStates(float DeltaTime)
{
...
void UCreatorsInput::UpdateGameKeys(float DeltaTime)
{
	ACreatorsPlayerController* MyController = CastChecked<ACreatorsPlayerController>(GetOuter());
...
void UCreatorsInput::DetectOnePointActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition, FVector2D& AnchorPosition, float& DownTime)
{
...
void UCreatorsInput::DetectTwoPointsActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition1, const FVector2D& CurrentPosition2)
{
...
FVector2D UCreatorsInput::GetTouchAnchor(int32 i) const
{
