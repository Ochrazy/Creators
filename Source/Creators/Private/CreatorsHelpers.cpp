...
bool FCreatorsHelpers::DeprojectScreenToWorld(const FVector2D& ScreenPosition, ULocalPlayer* Player, FVector& RayOrigin, FVector& RayDirection)
{
...
FVector FCreatorsHelpers::IntersectRayWithPlane(const FVector& RayOrigin, const FVector& RayDirection, const FPlane& Plane)
{
...
TSharedPtr<TArray<uint8>> FCreatorsHelpers::CreateAlphaMapFromTexture(UTexture2D* Texture)
{
...
FCanvasUVTri FCreatorsHelpers::CreateCanvasTri(FVector2D V0, FVector2D V1,FVector2D V2)
{
	FCanvasUVTri OutTri;
	OutTri.V0_Pos = V0;
	OutTri.V1_Pos = V1;
